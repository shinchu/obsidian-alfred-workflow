...
echo "   task [filter] - Search tasks / create new task"
echo "   start [filter] - Select task or free text to start tracking"
echo "   end          - Stop tracking, show duration"
echo "   brief        - Generate morning briefing"
echo "   review       - Generate daily review"
echo "   slk [filter]    - Attach Slack link to a task"
echo "   done [filter]   - Mark a task as completed"
